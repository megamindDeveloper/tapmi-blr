...
export const StyledMap = () => {
  ...
  if (!isLoaded) return <div className="flex items-center justify-center h-full bg-white">Loading Map...</div>;
      ...
      */}
      ...
      >
        <div className="p-2" style={{ transform: 'translateX(-50px) translateY(-03px)' }}>
           <p className="text-[#E31313] font-normal text-[12px] whitespace-nowrap bg-brand-dark px-2 py-1 rounded-md shadow-lg">
