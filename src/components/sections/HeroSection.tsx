    ...
    <section className="w-full h-[100vh] flex flex-col overflow-hidden">
      ...
      <div className="flex-1 w-full bg-gradient-to-r from-white via-[#bbedf7] to-[#B8EDF7] relative flex flex-col">
        ...
        <div className="flex-1 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-1 flex items-center relative z-10">
          {/* LEFT CONTENT */}
          <div className="w-full lg:w-[55%] py-4 sm:py-6 lg:py-8">
            <p className="text-[18px] sm:text-[24px] lg:text-[32px] text-[#1E9BB0] font-normal">
              Intersection 2026
            </p>

            <h1 className="text-[28px] sm:text-[38px] lg:text-[52px] leading-[1.2] sm:leading-[1.2] lg:leading-[60px] font-bold text-[#1E9BB0] mb-3 sm:mb-4">
              Navigating the<br />
              New Global Order
            </h1>

            <p className="text-[14px] sm:text-[18px] lg:text-[22px] text-[#000000CC] mb-4 sm:mb-5 lg:mb-6">
              PhD Colloquium on Management,<br />
              Social Sciences, and Humanities
            </p>

            <button className="bg-[#1E9BB0] hover:bg-[#1a8a9d] transition text-white px-3 sm:px-4 py-2 sm:py-3 text-[12px] sm:text-[14px] font-medium mb-4 sm:mb-6 lg:mb-8">
              Submit Your Abstract
            </button>

            <p className="text-[12px] sm:text-[15px] lg:text-[18px] text-[#000000CC]">
        ...
        <div className="absolute bottom-0 right-0 w-[100%] h-[50%] sm:w-[90%] sm:h-[70%] lg:w-[80%] lg:h-[90%] z-10 pointer-events-none">
             <Image
        ...
        {/* BOTTOM VENUE STRIP */}
        <div className="w-full bg-[#1E9BB0] text-white py-3 sm:py-4 lg:py-7 relative z-5">
